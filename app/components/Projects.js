...
const Projects = () => {
  return (
    <div id='Project' className='bg-zinc-950 w-[100%] overflow-hidden xl:py-24 py-[8vh] md:h-[110vh] lg:h-[105vh] sm:h-[100vh]'>
        ...
        <div className="lg:w-[100vw] md:block hidden w-[150vw] h-[80vw] lg:h-[80vw] overflow-hidden bg-gradient-radial from-[#48c9af] opacity-30 backdrop-brightness-50 blur-3xl rounded-full xl:top-[-150vh] xl:left-[0vw] md:top-[-100vh] top-[-50vh] left-[-10vw] z-10 relative"></div>
